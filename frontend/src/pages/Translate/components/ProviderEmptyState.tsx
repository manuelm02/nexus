...
export function ProviderEmptyState() {
  return (
    <div className="nexus-surface flex flex-col gap-3 p-4 md:p-5">
      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-muted text-primary"><Settings className="h-5 w-5" /></div>
      <div>
        <h3 className="text-base font-extrabold text-foreground">还没有可用翻译模型</h3>
