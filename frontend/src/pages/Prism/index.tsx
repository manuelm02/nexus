...
import { prismApi } from '../../api/prism.api'
...
export default function PrismPage() {
  ...
  const { data: historyData } = useQuery({
    queryKey: ['prism-history'],
    queryFn: () => prismApi.history(),
  })

  const translateMutation = useMutation({
    mutationFn: () => prismApi.translate({ sourceText, targetLang, style: style || undefined }),
    onSuccess: ({ data }) => {
